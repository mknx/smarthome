...
<input type="hidden" name="hosted_button_id" value="9US39R75DAL9C">
<input type="image" src="https://www.paypalobjects.com/de_DE/DE/i/btn/btn_donate_LG.gif" border="0" name="submit" alt="Donate / Spenden">
</form>
